...
if(isset($_POST['submit'])){
    ...
    if(empty($_POST['subject']) || empty($_POST['name']) || empty($_POST['article'])){
        ...
        echo "<script>location.href='add_test_topic.php?response=error&class=danger&message=Please fill the Record';</script>";
...
// exit;
        ...
        if(!empty($video)){
            ...
            elseif(preg_match('/dai.ly/',$video)){
                ...
                header('location:add_test_topic.php?response=error&class=danger&message=This Video link is not supported');
        ...
        if(empty($image_name)){
            ...
            $query=mysqli_query($con,"insert into test_topic(test_subject_id,test_chapter_id ,topic_name,topic_embed,topic_image,topic_pic_description,topic_article,insert_by) values('$subject','$chapter','$name','$video_link','$location$image_name','$topic_title','$article','$insert_by')");



            if($query){

                echo "<script>location.href='add_test_topic.php?response=success&class=success&message=Record inserted Successfully';</script>";
                ...
                echo "<script>location.href='add_test_topic.php?response=error&class=danger&message=Error';</script>";
            ...
            // echo "insert into test_topic(test_subject_id,test_chapter_id ,topic_name,topic_embed,topic_image,topic_title,topic_article,insert_by) values('$subject','$chapter','$name','$video_link','$location$image_name','$topic_title','$article','$insert_by')";
            ...
            // exit;
                ...
                if($query){
                 ...
                 echo "<script>location.href='add_test_topic.php?response=error&class=danger&message=Error In Image';</script>";
                                    ...
                                    <form method="POST" action="#" enctype="multipart/form-data">
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <textarea  class="form-control" id="video" name="video"
                                                ...
                                                placeholder="Enter Video Link" rows="6"></textarea>
