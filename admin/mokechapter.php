...
$id=$_GET['id'];
                                $query=mysqli_query($con,"select test_subject.* , test_chapter.* from test_subject inner join test_chapter on test_subject.id = test_chapter.test_subject_id where test_chapter.id='$id'");
                                       ...
                                       <div class="table-wrap">
                                            ...
                                            <table class="table table-responsive-lg table-striped-columns">
                                                ...
                                                <tbody>
                                                    ...
                                                    $id=$_GET['id'];
                                                $a = 1;
                                                $query=mysqli_query($con,"select * from test_topic where test_subject_id = '$id' and status_post= 2");
                                                    if(mysqli_num_rows($query) > 0){
                                                      while($row=mysqli_fetch_assoc($query)){ 
                                                        ...
                                                        .'<td>'.$a++.'</td>'
                                                         .'<td><a href="moketopic.php?id='.$row['id'].'">'.$row['topic_name'].'</a></td>'.
