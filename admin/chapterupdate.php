...
<?php
	...
	ch_title("Moalym", "Update Chapter");
        ?>
<div id="wrapper">
                                    ...
                                    <form method="POST" action=""
                                       ...
                                       <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="name" name="name"
                                                placeholder="Enter Chapter" value="<?=$name;?>" required>
                                            <label for="text">Enter Chapter</label>
                                        </div>
...
<?php
    // include('includeFile/footer.php');
     include_once(BASE_PATH.'admin/phpScript/update_chapter_script.php'); 
