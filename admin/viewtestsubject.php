                                    ...
                                    <div class="col-md-12">
                                                    ...
                                                    if(mysqli_num_rows($query) > 0){
                                                      while($row=mysqli_fetch_assoc($query)){ 
                                                        ...
                                                        .'<td>'.$row['subject_name'].'</td>'
                                                         .'<td><img src="'.BASE_URL.$row['subject_image'].'" alt="'.$row['subject_name'].'" style="width: 100px; height: 100px;"></td>'
                                                           ;
                                        ...
                                        elseif ($row['status_post'] == 3) {
                                            echo '<td>Rejected</td>';
                                                        ...
                                                        <a href="testsubjectupdate.php?id=' .$row['id'].'" class="pay_link"><i class="fa fa-pencil" aria-hidden="true"></i></a>/<a href="phpDeleteScript/testsubjectdelete.php?id='.$row['id'].'"><i class="fa fa-trash" aria-hidden="true"></i></a>
