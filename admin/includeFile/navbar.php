                          ...
                          if (@$_SESSION['user']['role'] == 'admin') {
                              echo'
								...
								<li class="menu-has-children"><a href="#">Academic </a>
									<ul>
										<li><a href="viewacademic.php">View Academic</a></li>
								...
								<li class="menu-has-children"><a href="#">Test Subjectr </a>
									<ul>
										<li><a href="viewtestsubject.php">View Subject</a></li>
										<li><a href="testsubject.php">Add Subject</a></li>
									</ul>
								</li>
