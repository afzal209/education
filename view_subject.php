                                            ...
                                            <table class="table table-striped-columns">
                                                ...
                                                <thead style="background-color: green;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="thed" scope="col">Subject</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    $view_subject = view_subject($con,NULL,NULL);

                                                    // print_r($view_subject);  

                                                    for ($i=0; $i < count($view_subject) ; $i++) { 

                                                        // print_r( $view_subject[$i]['academic_name']);

                                                        echo '<tr>'

                                                        .'<td>'.$view_subject[$i]['academic_name'].'</td>'

                                                        .'<td>'.$view_subject[$i]['subject_name'].'</td>'

                                                        .'<td style="text-align : center"><a href=""  data-bs-toggle="modal" data-bs-target="#myModal"  data-id="'.$view_subject[$i]['subject_image'].'" class="pay_link"><i class="fa fa-eye" aria-hidden="true"></i></a> </td>';

                                                        if ($view_subject[$i]['status_post'] == 1) {

                                                            echo '<td>Pending</td>';

                                                        }

                                                        elseif ($view_subject[$i]['status_post'] == 2) {
