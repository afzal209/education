...
$view_topic = get_topic_id($con,$id);
// print_r($view_topic);
?>
<?php 
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xs-12 ">
                ...
                <div>
                <a href="quizz.php?id=<?=$view_topic[$i]['id']?>&chap_id=<?=$view_topic[$i]['chapter_id']?>&sub_id=<?=$view_topic[$i]['subject_id']?>&acad_id=<?=$view_topic[$i]['academy_id']?>" class="btn btn-primary" style="color:white;margin-right:30%">Attempt Question</a>    
                </div>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                ...
                <ul class="blog">
                    ...
                    <li>
                        ...
                        <a
                            href="blog.php?id=<?=$view_tp[$i]['id']?>&acad_id=<?=$view_tp[$i]['academy_id']?>&sub_id=<?=$view_tp[$i]['subject_id']?>&chap_id=<?=$view_tp[$i]['chapter_id']?>">
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <h3> <?=$view_tp[$i]['topic_title']?></h3>
