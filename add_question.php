...
if(isset($_POST['submit'])){
    ...
    if( empty($_POST['subject']) || empty($_POST['chapter']) || empty($_POST['question']) || empty($_POST['correct']) || empty($_POST['option1']) || empty($_POST['option2']) || empty($_POST['option3']) || empty($_POST['option4'])){
        ...
        echo "<script>location.href='add_question.php?response=error&class=danger&message=All fields are mandatory.';</script>";
        ...
        $query=mysqli_query(
            ...
            $con,"insert into question (academy_id,subject_id,chapter_id,topic_id,question,correct,option1,option2,option3,option4,insert_by)



                    values('$academic','$subject','$chapter','$topic','$new','$correct','$option1','$option2','$option3','$option4','$insert_by')
            ...
            if($query){
                ...
                echo "<script>location.href='add_question.php?response=success&class=success&message=Record has been added.';</script>";
