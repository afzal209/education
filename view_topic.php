                                        ...
                                        <div class="table-wrap">
                                            ...
                                            <table class="table table-striped-columns">
                                                ...
                                                <tbody>
                                                    ...
                                                    $view_topic = view_topic($con);

                                                    // print_r($view_topic);

                                                    for ($i=0; $i < count($view_topic) ; $i++) { 

                                                        // print_r( $view_topic[$i]['academic_name']);

                                                        echo '<tr>'

                                                        .'<td>'.$view_topic[$i]['academic_name'].'</td>'

                                                        .'<td>'.$view_topic[$i]['subject_name'].'</td>'

                                                        .'<td>'.$view_topic[$i]['chapter_name'].'</td>'

                                                        .'<td>'.$view_topic[$i]['topic_name'].'</td>';

                                                        if ($view_topic[$i]['status_post'] == 1) {

                                                            echo '<td>Pending</td>';

                                                        }

                                                        elseif ($view_topic[$i]['status_post'] == 2) {
                                                    ...
                                                    // print_r(view_topic($con,'academic'));
