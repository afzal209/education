...
<section class="page-section">
    <div class="container">
        <div class="row">
            <div class="content">
                <?php 
                $topic_name = get_column($con,'topic','topic_name',$id);
                ...
                $id = $_GET['id'];
                $a = 1;
                $query3 = mysqli_query($con, "SELECT topic.topic_name, question.* 
                FROM topic
            ...
            //    print_r($row3);
                $query2 = mysqli_query($con, "select count(*) as total from question where topic_id = '$id'");
                ...
                <h1 class="text-center border"><a class="pull-left" href="#"><i class="fa fa-angle-left"></i></a> <?=$topic_name['topic_name']?>
                    Quiz <a class="pull-right" href="javascript:void(0);" data-option="<?=$row3['correct']?>" onclick="SubmitQuestion(this,'quizz.php?id=<?php echo @$id?>&page=<?php echo ($page1 + 1);?>&chap_id=<?php echo @$chapter_id;?>&sub_id=<?php echo @$subject_id; ?>&acad_id=<?php echo @$academy_id ?>','skip')">Skip</a>
                </h1>
                ...
                <?php 
                        ...
                        ?>
                <h1><?=$academic_name['academic_name']?> Class <?=$subject_name['subject_name']?> Chapters</h1>
                    ...
                    <?php 
                            ...
                            if (mysqli_num_rows($query) == 0) {
                                ...
                                while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    echo'
                                    <li>
                                        <input type="radio" class="pull-right scales"  data-option="'.$row['option'.$i].'" id="option'.$i.'" name="option'.$i.'" onclick="SubmitQuestion(this,\'quizz.php?id='.@$id.'&page='.(@$page + 1).'&chap_id='.@$chapter_id.'&sub_id='.@$subject_id.'&acad_id='.@$academy_id.'\',\'next\');"  />
