                                        ...
                                        <div class="table-wrap">
                                            <table class="table table-striped-columns">
                                                <thead style="background-color: green;">
                                                    <tr>
                                                        <th class="thed" scope="col">Name</th>
                                                ...
                                                <tbody>
                                                    <?php 
                                                    $view_academic = view_academic($con,NULL);
                                                    // print_r($view_academic);
                                                    for ($i=0; $i < count($view_academic) ; $i++) { 
                                                        // print_r( $view_academic[$i]['academic_name']);
                                                        echo '<tr>'
                                                        .'<td>'.$view_academic[$i]['academic_name'].'</td>'
                                                        .'<td style="text-align : center"><a href=""  data-bs-toggle="modal" data-bs-target="#myModal"  data-id="'.$view_academic[$i]['academic_image'].'" class="pay_link"><i class="fa fa-eye" aria-hidden="true"></i></a> </td>'
                                                        .'<td>'.ucwords($view_academic[$i]['insert_type']).'</td>';
                                                        if ($view_academic[$i]['status_post'] == 1) {
                                                            echo '<td>Pending</td>';
                                                        }
                                                        elseif ($view_academic[$i]['status_post'] == 2) {
                                                            echo '<td>Approve</td>';
                                                        }
                                                        else{
                                                            echo '<td>Rejected</td>';
                                                    ...
                                                    // print_r(view_academic($con,'academic'));
